...
describe("Calendars", () => {
	test.each([
		[
			1,
			{
				begin: DateTime.parse("2023-05-17", TimeZone.utc),
				end: DateTime.parse("2023-05-17", TimeZone.utc),
			},
		],
		[
			2,
			{
				begin: DateTime.parse("2023-05-17", TimeZone.utc),
				end: DateTime.parse("2023-05-18", TimeZone.utc),
			},
		],
		[
			2,
			{
				begin: DateTime.parse("2023-05-17", TimeZone.utc),
				end: DateTime.parse("2023-05-18T23:59:59", TimeZone.utc),
			},
		],
	...
	test.each([
		[
			1,
			DateTime.parse("2023-05-17", TimeZone.utc),
			DateTime.parse("2023-05-17", TimeZone.utc),
		],
		[
			1,
			DateTime.parse("2023-05-17", TimeZone.utc),
			DateTime.parse("2023-05-18", TimeZone.utc),
		],
		[
			2,
			DateTime.parse("2023-05-17", TimeZone.utc),
			DateTime.parse("2023-05-18T00:00:01", TimeZone.utc),
		],
		[
			2,
			DateTime.parse("2023-05-17", TimeZone.utc),
			DateTime.parse("2023-05-18T23:59:59", TimeZone.utc),
		],
		[
			1,
			DateTime.parse("2023-05-19T23:59:59", TimeZone.utc),
			DateTime.parse("2023-05-19T23:59:59", TimeZone.utc),
		],
		[
			2,
			DateTime.parse("2023-03-07", TimeZone.utc),
			DateTime.parse("2023-03-08T12:00:00", TimeZone.utc),
		],
		[
			1,
			DateTime.parse("2023-03-07", TimeZone.utc),
			DateTime.parse("2023-03-07T12:00:00", TimeZone.utc),
		],
		[
			8,
			DateTime.parse("2023-03-08", TimeZone.utc),
			DateTime.parse("2023-03-15T06:00:00", TimeZone.utc),
		],
		[
			8,
			DateTime.parse("2023-03-08T12:00:00", TimeZone.utc),
	...
	test.each([
		[
			1,
			DateTime.parse("2023-05-01", TimeZone.utc),
			DateTime.parse("2023-05-01", TimeZone.utc),
		],
		[
			2,
		...
		[
			3,
			DateTime.parse("2023-05-01", TimeZone.utc),
			DateTime.parse("2023-07-01", TimeZone.utc),
		],
		[
			8,
			DateTime.parse("2023-05-01", TimeZone.utc),
			DateTime.parse("2023-12-01", TimeZone.utc),
		],
		[
			9,
			DateTime.parse("2023-05-01", TimeZone.utc),
			DateTime.parse("2024-01-01", TimeZone.utc),
		],
		[
			12,
			DateTime.parse("2023-05-01", TimeZone.utc),
			DateTime.parse("2024-04-01", TimeZone.utc),
		],
		[
			13,
			DateTime.parse("2023-05-01", TimeZone.utc),
			DateTime.parse("2024-05-01", TimeZone.utc),
		],
	...
	test.each([
		...
		const events: HolidayEventMap = new Map();
		const regulars: HolidayRegulars = new Set([0, 6]);
		const actual = Calendars.isHoliday(date, regulars, events);
	...
	test.each([
		...
		const regulars: HolidayRegulars = new Set([0, 5]);
		const events: HolidayEventMap = new Map([
			[DateTime.parse("2023-05-31", TimeZone.utc).ticks, dummy],
			[DateTime.parse("2023-06-06", TimeZone.utc).ticks, dummy],
		]);
