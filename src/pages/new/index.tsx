...
import type { Member, Setting, WeekDay } from "@/models/data/Setting";
...
const NewPage: NextPage = () => {
	...
	return (
		<Layout mode="page" layoutId="new" title={locale.pages.new.title}>
			<p>{locale.pages.new.description}</p>

			<form onSubmit={handleSubmit((data) => onSubmit(data, timeZone, router))}>
				<dl className="inputs">
					<dt>
						<label htmlFor={id.title}>{locale.pages.new.projectName}</label>
					</dt>
					<dd>
						<input
							id={id.title}
					...
					<dt>{locale.pages.new.range.title}</dt>
					<dd>
					...
					<dt>{locale.pages.new.mode.title}</dt>
					<dd>
						<ul className="inline">
							<li>
								<label>
				...
				<button className="action">{locale.pages.new.submit}</button>
			</form>
		</Layout>
	);
};
...
function convertDateRange(data: Input, timeZone: TimeZone): DateRange {
	const begin = DateTime.create(
		timeZone,
		data.rangeBeginYear,
		data.rangeBeginMonth,
	);
...
function createSampleSetting(data: Input, timeZone: TimeZone): Setting {
	...
	setting.groups.push({
		...
		name: "1.作業班",
		members: [members.wa, members.wb],
	});
	setting.groups.push({
		id: IdFactory.createGroupId(),
		name: "2.検証班",
		members: [members.va, members.vb],
	});
	setting.groups.push({
		id: IdFactory.createGroupId(),
		name: "3.管理班",
		members: [members.ma, members.mb],
	});
	...
	setting.rootTimeline.children = [
		{
			...
			previous: [],
			static: Timelines.serializeDateTime(
				calendarRange.begin.add(TimeSpan.fromDays(10)),
			),
			progress: 0,
		...
		//--------------------------
		{
			...
			subject: "後の上位工程",
			comment: "",
			previous: ["c9072f81-bfdb-402b-9c0d-3a55ab79da5f"],
			workload: "1.00:00:00",
			memberId: "",
			progress: 0,
		},
					...
					children: [
						{
							...
							subject: "現地確認",
							comment: "",
							previous: ["680e27c0-7320-441e-9ec1-cf485996824e"],
							workload: "1.00:00:00",
						...
						},
						{
							...
							subject: "顧客確認",
							comment: "",
							previous: ["8729fcd6-69ec-44b9-86f0-a51d186d2b12"],
							workload: "1.00:00:00",
							memberId: "f7294ba4-6775-4f07-a009-5b83231310c8",
							progress: 0,
						},
				...
				},
				{
					...
					children: [
						...
						},
						{
							...
							subject: "機器整理",
							comment: "",
							previous: ["f4a9fb31-82ab-410f-ae42-6d7977de3eec"],
							workload: "2.00:00:00",
							memberId: "755460d6-2b3b-42ef-99e5-4a8e8efbe779",
							progress: 0,
						},
					...
					children: [
						{
							...
							subject: "設計-要件A",
							comment: "",
							previous: ["b65076ae-e2be-40ea-93ea-d36bbfa8bfd2"],
							workload: "2.00:00:00",
							memberId: "8beb418d-0523-4cff-8a3f-6fbc642e8f7b",
							progress: 0,
						},
						...
						},
						{
							...
							subject: "設計-要件C",
							comment: "",
							previous: ["598b203c-8c04-4122-8d50-06d3ea9e259b"],
							workload: "2.00:00:00",
							memberId: "8beb418d-0523-4cff-8a3f-6fbc642e8f7b",
							progress: 0,
						},
						{
							...
							subject: "設計-要件D",
							comment: "",
							previous: ["de7e4757-d56f-48ae-b6a1-ddef6c089ddf"],
							workload: "2.00:00:00",
							memberId: "755460d6-2b3b-42ef-99e5-4a8e8efbe779",
							progress: 0,
						},
						{
							...
							subject: "設計-要件E",
							comment: "",
							previous: ["cb9b1c74-3727-4b8e-a1ed-4db7c8880d18"],
							workload: "4.00:00:00",
							memberId: "8beb418d-0523-4cff-8a3f-6fbc642e8f7b",
							progress: 0,
						},
						{
							...
							subject: "設計-要件F",
							comment: "",
							previous: ["449915f4-3107-48fc-aa7b-767e87817661"],
							workload: "1.00:00:00",
							memberId: "755460d6-2b3b-42ef-99e5-4a8e8efbe779",
							progress: 0,
						},
			...
			children: [
				{
					...
					children: [
						...
						},
						{
							...
							subject: "作業-要件C",
							comment: "",
							previous: ["0627a5c3-0107-4cfc-a69d-756b5b440c72"],
							workload: "2.00:00:00",
							memberId: "8beb418d-0523-4cff-8a3f-6fbc642e8f7b",
							progress: 0,
						},
						{
							...
							subject: "作業-要件D",
							comment: "",
							previous: ["a130c8f6-264b-49cc-a909-2b84d2cd74be"],
							workload: "2.00:00:00",
							memberId: "755460d6-2b3b-42ef-99e5-4a8e8efbe779",
							progress: 0,
						},
						{
							...
							subject: "作業-要件E",
							comment: "",
							previous: ["9f4b1cef-3da6-4f11-8d99-cdf1b8c5392b"],
							workload: "5.00:00:00",
							memberId: "8beb418d-0523-4cff-8a3f-6fbc642e8f7b",
							progress: 0,
						},
						{
							...
							subject: "作業-要件F",
							comment: "",
							previous: ["34a3db1d-645a-4136-9216-0e8631e8240e"],
							workload: "1.00:00:00",
							memberId: "755460d6-2b3b-42ef-99e5-4a8e8efbe779",
							progress: 0,
						},
			...
			children: [
				{
					...
					children: [
						...
						},
						{
							...
							subject: "検証-要件C",
							comment: "",
							previous: ["351216b9-1a20-42ba-a325-2fa8b7b04f64"],
							workload: "1.00:00:00",
							memberId: "fef6751a-e7e6-4d4b-8d86-3b58448c83a3",
							progress: 0,
						},
						{
							...
							subject: "検証-要件D",
							comment: "",
							previous: ["1cad2b3e-88e2-4b95-8299-cb658951e5a9"],
							workload: "1.00:00:00",
							memberId: "7421f139-fd9a-420b-aa86-781ffbfd8113",
							progress: 0,
						},
						{
							...
							previous: ["774200fb-97fe-497e-82e2-16d8d5f152e1"],
							workload: "4.00:00:00",
							memberId: "fef6751a-e7e6-4d4b-8d86-3b58448c83a3",
							progress: 0,
						},
						{
							...
							subject: "検証-要件F",
							comment: "",
							previous: ["0e8bdc6c-f310-4a8a-8c15-6f92a6726a72"],
							workload: "3.00:00:00",
							memberId: "7421f139-fd9a-420b-aa86-781ffbfd8113",
							progress: 0,
						},
				...
				},
				{
					...
					subject: "検証戻り対応A",
					comment: "",
					previous: ["e407fa61-333b-41b9-8c73-e4ca27dde33a"],
					workload: "8.00:00:00",
					memberId: "8beb418d-0523-4cff-8a3f-6fbc642e8f7b",
					progress: 0,
				},
		...
		},
		{
			...
			subject: "納品",
			comment: "",
			previous: ["ded9cd24-5747-43f4-a129-c0a540a18843"],
			workload: "2.00:00:00",
			memberId: "f7294ba4-6775-4f07-a009-5b83231310c8",
			progress: 0,
		},
		{
			...
			previous: ["9544ff54-d179-4814-9adf-1095ed418f48"],
			workload: "1.00:00:00",
			memberId: "",
			progress: 0,
		},
